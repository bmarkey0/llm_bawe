...
cond1 = """
You're a teacher grading a paper. Use a five point scale to grade whether the following paper is clear. Use a five point 
scale, where 1 is the least clear and 5 is the most clear. Do not summarize or give feedback. Just give the grade 
(e.g., level 2, level 4, etc.). 
"""

cond2 = """
You're a teacher grading a paper. Use a five point scale to grade whether the following paper is clear. Use a five point
scale, where 1 is the most unclear and 5 is the most clear. Do not summarize or give feedback. Just give the grade 
(e.g., level 2, level 4, etc.).
"""

cond3 = """
You're a teacher grading a paper. Use a five point scale to grade whether the following paper is clear. Do not summarize 
or provide feedback. Just give the grade (e.g., level 2, level 4).  Use the following five point scale, where level 
5 is the highest and level 1 is the lowest: 

5: Precise use of a variety of words and sentence structures to create clear prose. Careful integration of academic 
vocabulary strengthens and furthers ideas. Almost all sentences and phrases are effectively crafted to convey the 
writer’s ideas and contribute to the overall quality of the response and the clarity of the message.

4: Generic use of a variety of words creates clear prose. Integration of academic vocabulary demonstrates clear 
expression of ideas. Almost all sentences convey writer’s ideas and mostly contribute to the overall quality of the 
response and the clarity of the message. 

3: Vocabulary and word choice is somewhat varied, though imprecise, demonstrating partial command of expression 
of ideas. The writer’s word choice is imprecise and at times does not convey the writer’s ideas clearly. Sentences 
and phrases are at times ineffective and interfere with the writer’s intended meaning and weaken the message.

2: Limited word choice demonstrates limited command of expression of ideas. The writer’s word choice is basic and 
does not convey the writer’s ideas clearly. Sentences and phrases are general and interfere with the writer’s 
intended meaning and weaken the message. 

1: Minimal variety in word choice demonstrates poor command of express of ideas. Vocabulary and word choice 
is vague, unclear, or confusing. The expression of ideas is unclear and/or incoherent.

"""

cond4 = """
You're a teacher grading a paper. Use a five point scale to grade whether the following paper is clear. Do not summarize 
or provide feedback. Just give the grade (e.g., level 2, level 4).  Use a five point scale, where level 5 is the 
highest and level 1 is the lowest. Here are descriptions of levels 5, 3, and 1: 

5: Precise use of a variety of words and sentence structures to create clear prose. Careful integration of academic 
vocabulary strengthens and furthers ideas. Almost all sentences and phrases are effectively crafted to convey 
the writer’s ideas and contribute to the overall quality of the response and the clarity of the message.

3: Vocabulary and word choice is somewhat varied, though imprecise, demonstrating partial command of expression 
of ideas. The writer’s word choice is imprecise and at times does not convey the writer’s ideas clearly. Sentences 
and phrases are at times ineffective and interfere with the writer’s intended meaning and weaken the message.

1: Minimal variety in word choice demonstrates poor command of express of ideas. Vocabulary and word choice is vague, 
unclear, or confusing. The expression of ideas is unclear and/or incoherent.

When assessing, just give the grade. Do not give feedback.
"""

cond5 = """
You're a teacher grading a paper. Use a five point scale to grade whether the following paper is clear. 
Do not summarize or provide feedback. Just give the grade (e.g., level 2, level 4, etc.). Use the following five point 
scale, where level 5 is the highest and level 1 is the lowest:
...
if __name__ == "__main__":
    ...
    for item in temp_lst:
        ...
        pq.write_table(out_table, os.path.join(args.outdir, model_name + f"#Essay_clarity_{item}.parquet"), compression="gzip")
